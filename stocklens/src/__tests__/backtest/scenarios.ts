...
export const GME_SCENARIOS: MarketSnapshot[] = [
  ...
  },
  {
    ...
    expectedRegime: 'mid-cap', // price blew it above $5, mktcap temporarily mid-cap
  ...
  },
  {
    ...
    expectedRegime: 'large-cap', // $15B mktcap during attempt = large-cap
  ...
  },
  {
    ...
    expectedRegime: 'mid-cap', // $4.2B = mid-cap
...
export const BP_SCENARIOS: MarketSnapshot[] = [
  {
    ...
    // Engine correctly surfaces the risk via Watch (below 200MA, negative EPS)
    expectedCFMin: 55, expectedCFMax: 80,
  },
  {
