...
function scoreToColor(score: number): string {
  ...
  if (score >= 50) return '#84CC16'; // yellow-green
...
export default function ConfidenceGauge({ score, size = 200 }: Props) {
  ...
  // Animate the number and arc on mount / score change
  useEffect(() => {
    const duration = 800;
  ...
  // We only show 270° of the circle (3/4 arc), starting from bottom-left
  ...
  // Rotation: start the arc from the bottom-left (-225deg from 3 o'clock = 135deg)
  ...
  return (
    ...
    >
      ...
      {/* Label below gauge */}
      <div
        className="absolute bottom-0 left-1/2 -translate-x-1/2 pb-1 text-sm font-semibold tracking-wide"
